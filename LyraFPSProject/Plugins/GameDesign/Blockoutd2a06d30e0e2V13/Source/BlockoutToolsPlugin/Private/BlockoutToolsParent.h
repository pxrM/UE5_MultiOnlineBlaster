...
public:	
	...
	UPROPERTY(BlueprintReadOnly, Category = "Blockout Tools")
	TObjectPtr<UMaterialInterface> BlockoutGridParent;

	UPROPERTY(BlueprintReadOnly, Category = "Blockout Tools")
	TObjectPtr<UMaterialInstanceDynamic> BlockoutGridMID;

	UPROPERTY(BlueprintReadOnly, Category = "Blockout Tools")
	TObjectPtr<UMaterialInterface> BlockoutCurrentMaterial;

	UPROPERTY(BlueprintReadOnly, Category = "Blockout Tools")
	TArray<TObjectPtr<UStaticMeshComponent>> BlockoutMeshComponents;
	...
	TObjectPtr<UMaterialInterface> BlockoutCustomMaterial;
