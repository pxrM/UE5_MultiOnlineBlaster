...
class LYRAGAME_API ULyraPawnComponent_CharacterParts : public UPawnComponent
{
	GENERATED_BODY()
...
public:
	...
	virtual USceneComponent* GetSceneComponentToAttachTo(const FLyraCharacterPart& Part) const;
