 ...
 */
struct LYRAGAME_API FLyraCameraModeView
{
public:
...
public:
	...
	ULyraCameraMode* GetCurCameraMode() const{return CameraModeStack.IsEmpty()? nullptr : CameraModeStack[CameraModeStack.Num()-1]; };
protected:
