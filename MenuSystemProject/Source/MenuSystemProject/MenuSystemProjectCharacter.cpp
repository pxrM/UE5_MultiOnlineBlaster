...
//////////////////////////////////////////////////////////////////////////
// AMenuSystemProjectCharacter

AMenuSystemProjectCharacter::AMenuSystemProjectCharacter()
	:CreateSessionCompleteDelegate(FOnCreateSessionCompleteDelegate::CreateUObject(this, &AMenuSystemProjectCharacter::OnCreateSessionComplete))
...
void AMenuSystemProjectCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AMenuSystemProjectCharacter::CreateGameSession()
{
...
void AMenuSystemProjectCharacter::JoinGameSession()
{
	if (!OnlineSessionInterface.IsValid())
	{
		return;
...
void AMenuSystemProjectCharacter::OnCreateSessionComplete(FName SessionName, bool bWasSuccessful)
{
	if (bWasSuccessful)
	{
		if (GEngine)
...
void AMenuSystemProjectCharacter::OnFindSessionComplete(bool bWasSuccessful)
{
	if (!OnlineSessionInterface.IsValid())
	{
		return;
...
void AMenuSystemProjectCharacter::OnJionSessionComplete(FName SessionName, EOnJoinSessionCompleteResult::Type Result)
{
	if (!OnlineSessionInterface.IsValid())
	{
		return;
...
void AMenuSystemProjectCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AMenuSystemProjectCharacter::Move);

		//Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AMenuSystemProjectCharacter::Look);

	}

}

void AMenuSystemProjectCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AMenuSystemProjectCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
